...
train_data = utils.load_data(os.path.join(pathlib.Path(
    __file__).parent.absolute(), 'reviews_train.tsv'))
val_data = utils.load_data(os.path.join(pathlib.Path(
    __file__).parent.absolute(), 'reviews_val.tsv'))
test_data = utils.load_data(os.path.join(pathlib.Path(
    __file__).parent.absolute(), 'reviews_test.tsv'))
...
#     os.path.join(pathlib.Path(__file__).parent.absolute(), 'toy_data.tsv'))
