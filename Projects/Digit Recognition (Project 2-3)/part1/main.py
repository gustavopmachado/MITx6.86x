...
temp_parameter = 1
theta_pca, _ = softmax_regression(
    train_cube, train_y, temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
# Evaluates the PCA trained model
test_error_cube = compute_test_error(
    test_cube, test_y, theta_pca, temp_parameter)

print('\n', 'Softmax Regression [Cubic Kernel on 10-PCA] Test Error (T = 1):',
      test_error_cube)
