...
def get_data(path_to_data_dir, use_mini_dataset):
    ...
    f = gzip.open(os.path.join(Path(__file__).parent.parent,
                               'Datasets', 'train_multi_digit' + exten + '.pkl.gz'), 'rb')
    ...
    f = gzip.open(os.path.join(Path(__file__).parent.parent,
                               'Datasets', 'test_multi_digit' + exten + '.pkl.gz'), 'rb')
